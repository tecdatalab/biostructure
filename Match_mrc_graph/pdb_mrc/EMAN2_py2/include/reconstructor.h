/**
 * $Id: reconstructor.h,v 1.161 2015/10/05 09:07:38 pawel Exp $
 */
...
//		FourierPixelInserter3D* inserter;
	...
	class nn4_rectReconstructor:public Reconstructor
	{
	  ...
	  private:
		...
		float m_xscale,m_yscale;//ratio of x,y direction of 2D FFT after scaling and roatating operations
     ...
     *
     */
	class nn4_ctfwReconstructor:public Reconstructor
	{
	  public:
