...
import sys
import os
sys.path.append(str(os.path.dirname(os.path.abspath(__file__)))+"/../../EMAN2_py2/extlib/bin")
sys.path.append(str(os.path.dirname(os.path.abspath(__file__)))+"/../../EMAN2_py2/lib")
sys.path.append(str(os.path.dirname(os.path.abspath(__file__)))+"/../../EMAN2_py2/bin")
sys.path.append(str(os.path.dirname(os.path.abspath(__file__)))+"/../../EMAN2_py2")
