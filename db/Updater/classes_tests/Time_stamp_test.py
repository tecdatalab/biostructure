...
def test_5_insert_db(postgresql):
    ...
    assert result[0] == Time_stamp(1,(2018,2,14),"mapFile","xmlFile","imageFile")
...
def test_6_update_db(postgresql):
    ...
    result = get_time_stamps(postgresql)
    assert result[0] == Time_stamp(1,(2018,2,15),"mapFileup","xmlFileup","imageFileup")
...
def create_time_stamps():
    resultado = []
    resultado.append(Time_stamp(1,(2018,2,14),"mapFile","xmlFile","imageFile"))
    return resultado
