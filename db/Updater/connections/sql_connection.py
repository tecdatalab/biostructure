...
class SQL_connection(object):
    ...
    def init_connection(self):
        connstr = "host=%s port=%s user=%s password=%s dbname=%s" % (
            self.__PSQL_HOST, self.__PSQL_PORT, self.__PSQL_USER, self.__PSQL_PASS, self.__PSQL_DB)
    ...
    PSQL_HOST = property(
        ...
        set_psql_host,
        del_psql_host,
        "PSQL_HOST's docstring")
    PSQL_PORT = property(
        get_psql_port,
        set_psql_port,
        del_psql_port,
        "PSQL_PORT's docstring")
    PSQL_USER = property(
        get_psql_user,
        set_psql_user,
        del_psql_user,
        "PSQL_USER's docstring")
    PSQL_PASS = property(
        get_psql_pass,
        set_psql_pass,
        del_psql_pass,
        "PSQL_PASS's docstring")
    PSQL_DB = property(
        get_psql_db,
        set_psql_db,
        del_psql_db,
