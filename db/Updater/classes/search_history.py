...
class Search_history(object):
    ...
    name_file = property(
        ...
        set_name_file,
        del_name_file,
        "name_file's docstring")
    contour_level = property(
        get_contour_level,
        set_contour_level,
        del_contour_level,
        "contour_level's docstring")
    representation_id = property(
        get_representation_id,
        set_representation_id,
        del_representation_id,
        "representation_id's docstring")
    volume_filter_id = property(
        get_volume_filter_id,
        set_volume_filter_id,
        del_volume_filter_id,
        "volume_filter_id's docstring")
    resolution_filter_min = property(
        get_resolution_filter_min,
        set_resolution_filter_min,
        del_resolution_filter_min,
        "resolution_filter_min's docstring")
    resolution_filter_max = property(
        get_resolution_filter_max,
        set_resolution_filter_max,
        del_resolution_filter_max,
        "resolution_filter_max's docstring")
