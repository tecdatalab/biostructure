...
class Time_stamp(object):
    ...
    def __init__(
        ...
        if isinstance(modification, datetime.date):
            ...
            self.__modification = date(
                modification[0], modification[1], modification[2])
    ...
    def insert_db(self, cur):
        cur.execute(
            sql.SQL("INSERT INTO time_stamp(emd_entry_id,modification,map_file,xml_file,image_file) VALUES (%s,%s,%s,%s,%s);"), [
    ...
    modification = property(
        ...
        set_modification,
        del_modification,
        "modification's docstring")
    map_file = property(
        get_map_file,
        set_map_file,
        del_map_file,
        "map_file's docstring")
    xml_file = property(
        get_xml_file,
        set_xml_file,
        del_xml_file,
        "xml_file's docstring")
    image_file = property(
        get_image_file,
        set_image_file,
        del_image_file,
        "image_file's docstring")
