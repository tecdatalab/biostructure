...
class Cath_atomic_structure(object):
    ...
    def __init__(
            ...
            S35_sequence_cluster_number,
            S60_sequence_cluster_number,
            S95_sequence_cluster_number,
    ...
    CATH_domain_name = property(
        get_cath_domain_name,
        set_cath_domain_name,
        del_cath_domain_name,
        "CATH_domain_name's docstring")
    lass_number = property(
        get_lass_number,
        set_lass_number,
        del_lass_number,
        "lass_number's docstring")
    architecture_number = property(
        get_architecture_number,
        set_architecture_number,
        del_architecture_number,
        "architecture_number's docstring")
    topology_number = property(
        get_topology_number,
        set_topology_number,
        del_topology_number,
        "topology_number's docstring")
    homologous_superfamily_number = property(
        get_homologous_superfamily_number,
        set_homologous_superfamily_number,
        del_homologous_superfamily_number,
        "homologous_superfamily_number's docstring")
    S35_sequence_cluster_number = property(
        get_s_35_sequence_cluster_number,
        set_s_35_sequence_cluster_number,
        del_s_35_sequence_cluster_number,
        "S35_sequence_cluster_number's docstring")
    S60_sequence_cluster_number = property(
        get_s_60_sequence_cluster_number,
        set_s_60_sequence_cluster_number,
        del_s_60_sequence_cluster_number,
        "S60_sequence_cluster_number's docstring")
    S95_sequence_cluster_number = property(
        get_s_95_sequence_cluster_number,
        set_s_95_sequence_cluster_number,
        del_s_95_sequence_cluster_number,
        "S95_sequence_cluster_number's docstring")
    S100_sequence_cluster_number = property(
        get_s_100_sequence_cluster_number,
        set_s_100_sequence_cluster_number,
        del_s_100_sequence_cluster_number,
        "S100_sequence_cluster_number's docstring")
    S100_sequence_count_number = property(
        get_s_100_sequence_count_number,
        set_s_100_sequence_count_number,
        del_s_100_sequence_count_number,
        "S100_sequence_count_number's docstring")
    domain_length = property(
        get_domain_length,
        set_domain_length,
        del_domain_length,
        "domain_length's docstring")
    structure_resolution = property(
        get_structure_resolution,
        set_structure_resolution,
        del_structure_resolution,
        "structure_resolution's docstring")
