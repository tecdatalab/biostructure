maps_with_pdb_origin = ['emd_0009.map', 'emd_0244.map', 'emd_0293.map', 'emd_0355.map', 'emd_0362.map', 'emd_0366.map',
                        ...
                        'emd_0790.map', 'emd_0901.map', 'emd_0979.map', 'emd_10132.map', 'emd_10194.map',
                        'emd_10373.map',
                        'emd_10464.map', 'emd_10699.map', 'emd_1181.map', 'emd_1261.map', 'emd_1263.map',
                        'emd_1884.map',
                        'emd_1918.map', 'emd_1983.map', 'emd_1988.map', 'emd_1989.map', 'emd_1990.map', 'emd_2005.map',
                        'emd_20267.map', 'emd_20287.map', 'emd_20493.map', 'emd_20511.map', 'emd_2071.map',
                        'emd_2072.map',
                        'emd_20721.map', 'emd_20813.map', 'emd_20924.map', 'emd_20931.map', 'emd_21121.map',
                        'emd_21335.map',
                        'emd_21585.map', 'emd_21602.map', 'emd_2233.map', 'emd_2528.map', 'emd_2594.map',
                        'emd_2595.map',
                        ...
                        'emd_9881.map', 'emd_9882.map', 'emd_10944.map', 'emd_10960.map', 'emd_10748.map',
                        'emd_10754.map',
                        'emd_11173.map']
